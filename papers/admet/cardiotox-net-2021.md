...
见 Data preparation 和外部测试结果；训练集与外部集做化学相似性分析。不能将外部测试及相似性分析改写成已比较随机与骨架划分。

两个外部集较小，第三个集阳性比例低，必须同时观察误报与召回。定位 2021 年端点代表方法，不宣称当前 SOTA。

## 代码与证据

[代码或项目入口](https://github.com/Abdulk084/CardioTox)
