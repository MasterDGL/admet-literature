...
This Perspective develops a research agenda around open data, mechanistic modeling and blind challenges.

Provides context for OpenADMET's motivation and plans for CYP, transporter and safety-related mechanistic datasets.

## Code and references

[Code and project](https://github.com/OpenADMET)

Links to the OpenADMET organization and its data, tools and challenge projects.

Sources reviewed: **2026-09-19**. Bibliographic metadata, key sections of the paper and related official resources.

- [Publisher full text](https://www.nature.com/articles/s41467-026-73410-8)
- [Official OpenADMET resources](https://github.com/OpenADMET)
