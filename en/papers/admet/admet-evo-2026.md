...
Uses preprint v2, covering 22 TDC tasks and 43 toxicity tasks with the authors' task-normalized aggregate metric.

96.77 is the paper's aggregate score. Model-fitting time is compared under the specified resource constraints; repository access status is recorded below.

## Code and references

The repository link in the paper could not be accessed during review.

Sources reviewed: **2026-09-19**. Bibliographic metadata, key sections of the paper and related official resources.

- [Preprint](https://arxiv.org/abs/2609.10121)
- [Version 2 full text](https://arxiv.org/html/2609.10121v2)
